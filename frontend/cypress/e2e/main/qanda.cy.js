describe('Ask question', () => {
  ...
  it('When signed in and ask a valid question, the question should successfully save', () => {
    ...
    cy.findByLabelText('Email address')
      .type(Cypress.env('email_username'))
      .should('have.value', Cypress.env('email_username'));

    cy.findByLabelText('Password')
      .type(Cypress.env('email_password'))
      .should('have.value', Cypress.env('email_password'));
